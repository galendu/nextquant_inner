...
class Quant:
    ...
    def _init_event_center(self):
        ...
        if config.handle_rabbitmq:
            from quant.event import EventHandleCenter
            self.handle_event_center = EventHandleCenter()
            self.loop.run_until_complete(self.handle_event_center.connect())
